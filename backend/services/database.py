...
# Store the SQLite file in the user's home dir so re-cloning the repo never wipes
# accounts/paths; override with DATABASE_PATH for deployments (e.g. Azure mounted volume)
_BACKEND_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
_DATA_DIR = os.path.join(os.path.expanduser("~"), ".course_forge")
DB_PATH = os.getenv("DATABASE_PATH", os.path.join(_DATA_DIR, "courseforge.db"))
